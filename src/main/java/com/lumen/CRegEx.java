...
//For example, the words love and to are repeated in the sentence I love Love to To tO code. Can you 
...
//Each of the  subsequent lines contains a single sentence consisting of English alphabetic letters 
...
//Explanation
//
//We remove the second occurrence of bye and the second and third occurrences of world from Goodbye 
//bye bye world world world to get Goodbye bye world.
//We remove the second occurrence of went and the second and third occurrences of to from Sam went 
//went to to to his business to get Sam went to his business.
...
//It's important to note that our matching is case-insensitive, and we specifically retained the 
//first occurrence of the matched word in our final string.
